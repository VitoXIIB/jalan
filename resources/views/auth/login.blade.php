				...
				<div class="col-md-12 col-lg-10">
			      	...
			      	<div class="d-flex">
			      		...
			      		<div class="form-group mb-3">
			      			...
			      			<input type="text" class="form-control" placeholder="Email" style="background-color: #4d475c; color: white;" autocomplete="off" name="email" required>
			      		</div>
		            <div class="form-group mb-3">
		            	<label class="label" for="password" style="color: white">Password</label>
		              <input type="password" class="form-control" placeholder="Password" style="background-color:#4d475c; color: white;" name="password" required>
		            </div>
		            <div class="form-group mb-3">
