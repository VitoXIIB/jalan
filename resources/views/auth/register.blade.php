                        ...
                        <div class=" col-md-12">
                            ...
                            <form action="/postregis" class="signin-form" method="POST">
                                ...
                                <div class="form-group mb-3 ">
                                    ...
                                    <input type="text" class="form-control" placeholder="NIK" name="nik" required style="background-color: #4d475c; color: white;" autocomplete="off">
                                </div>
                                <div class="form-group mb-3 ">
                                    <label class="label" for="name" style="color: white;">Nama</label>
                                    <input type="text" class="form-control" placeholder="Nama" name="nama" required style="background-color: #4d475c; color: white;" autocomplete="off">
                                </div>
                                <div class="form-group mb-3 ">
                                    <label class="label" for="name" style="color: white;">Telepon</label>
                                    <input type="text" class="form-control" placeholder="Telepon" name="telp" required style="background-color: #4d475c; color: white;" autocomplete="off">
                                </div>
                                <div class="form-group mb-3 ">
                                    <label class="label" for="name" style="color: white;">Email</label>
                                    <input type="email" class="form-control" placeholder="E-mail" name="email" required style="background-color: #4d475c; color: white;" autocomplete="off">
                                </div>
                                <div class="form-group mb-3 ">
                                    <label class="label" for="name" style="color: white;">Username</label>
                                    <input type="text" class="form-control" placeholder="Username" name="username" required style="background-color: #4d475c; color: white;" autocomplete="off">
                                </div>
                                <div class="form-group mb-3">
                                    <label class="label" for="password" style="color: white;">Password</label>
                                    <input type="password" class="form-control" placeholder="Password" name="password" required style="background-color: #4d475c; color: white;" autocomplete="off">
                                </div>
